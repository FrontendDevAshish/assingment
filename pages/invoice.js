...
import Coupons from "../components/invoice/Coupons";
import FixedBottom from "../components/invoice/FixedBottom";
      ...
      <div className="flex flex-col gap-10  bg-[#F2F7FB] p-[1.56rem] text-[#211F2B]  font-['Kumbh_Sans'] ">
        ...
        <p className="font-[400] leading-4 text-[0.875rem] text-[#83828E]">
          {showAll
            ...
            : " Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam euturpis molestie, dictum est a, mattis tellus. Sed dignissim, metusnec........."}
          <span
            onClick={() => setShowAll(() => !showAll)}
            className="font-[700] cursor-pointer"
          >
            {showAll ? "CLOSE" : "KNOW MORE"}
          </span>
        </p>
